...
public class GorillaUpgradeManager : MonoBehaviour {
    ...
    {
        foodUpgradeNumber = animalFoodButton.gorFoodLevel;
        habUpgradeNumber = animalHabButton.gorHabLevel;
        popUpgradeNumber = animalPopButton.gorSocialLevel;
    }
