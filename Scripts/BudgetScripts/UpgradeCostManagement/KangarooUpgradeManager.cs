...
public class KangarooUpgradeManager : MonoBehaviour {
    ...
    {
        foodUpgradeNumber = animalFoodButton.kangFoodLevel;
        habUpgradeNumber = animalHabButton.kangHabLevel;
        popUpgradeNumber = animalPopButton.kangSocialLevel;
    }
