...
public class PenguinUpgradeManager : MonoBehaviour 
{
    ...
    {
        foodUpgradeNumber = animalFoodButton.pengFoodLevel;
        habUpgradeNumber = animalHabButton.pengHabLevel;
        popUpgradeNumber = animalPopButton.pengSocialLevel;
    }

    void Update()
    {
        SetUpgradeNumbers();
        //print("pengu food: " + foodUpgradeNumber);
        //print("pengu hab: " + habUpgradeNumber);
        //print("pengu pop: " + popUpgradeNumber);
    }
