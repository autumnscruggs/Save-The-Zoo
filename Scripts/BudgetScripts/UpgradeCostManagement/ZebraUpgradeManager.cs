...
public class ZebraUpgradeManager : MonoBehaviour {
    ...
    {
        foodUpgradeNumber = animalFoodButton.zebFoodLevel;
        habUpgradeNumber = animalHabButton.zebHabLevel;
        popUpgradeNumber = animalPopButton.zebSocialLevel;
    }
