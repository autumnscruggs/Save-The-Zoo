...
public class ZebrasHappiness : MonoBehaviour
{
    ...
    [HideInInspector]
    public int ZebraHappinessTotal;
    ...
    void Update()
    {
        ...
        animalHap.DisplayMainAnimalHappiness(ZebraHappinessTotal, mainMenuTotalStars, subMenuTotalStars, phase2TotalStars);
    }
    ...
    void TotalAnimalHappiness()
    {
        ...
        ZebraHappinessTotal = foodHappiness + maintHappiness + socialHappiness;
    }
    ...
    {
        switch (animalFoodButton.zebFoodLevel)
        {
            case 0:
                foodHappiness += 0;
                break;
    ...
    {
        switch (animalHabButton.zebHabLevel)
        {
            case 0:
                maintHappiness += 0;
                break;
    ...
    {
        switch (animalSocialButton.zebSocialLevel)
        {
            case 0:
                socialHappiness += 0;
                break;
