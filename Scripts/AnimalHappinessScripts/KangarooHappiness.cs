...
public class KangarooHappiness : MonoBehaviour
{
    ...
    [HideInInspector]
    public int KangarooHappinessTotal;

    public Text mainMenuHappinessText;

    public int foodWorth = 30;
    public int maintenanceWorth = 25;
    public int socialWorth = 45;
    ...
    void Update()
    {
        ...
        animalHap.DisplayMainAnimalHappiness(KangarooHappinessTotal, mainMenuTotalStars, subMenuTotalStars, phase2TotalStars);
    }
    ...
    void TotalAnimalHappiness()
    {
        ...
        KangarooHappinessTotal = foodHappiness + maintHappiness + socialHappiness;
    }
    ...
    {
        switch (animalFoodButton.kangFoodLevel)
        {
            case 0:
                foodHappiness += 0;
                break;
    ...
    {
        switch (animalHabButton.kangHabLevel)
        {
            case 0:
                maintHappiness += 0;
                break;
    ...
    {
        switch (animalSocialButton.kangSocialLevel)
        {
            case 0:
                socialHappiness += 0;
                break;
